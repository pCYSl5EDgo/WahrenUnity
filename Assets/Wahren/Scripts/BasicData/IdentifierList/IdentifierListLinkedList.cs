...
namespace pcysl5edgo.Wahren.AST
{
    public unsafe struct IdentifierListLinkedList : ILinkedList<Span, IdentifierList>
    {
        ...
        public unsafe void AddRange(Span* copySource, int length, out IdentifierList* page, out int start, Allocator allocator) => List.AddRange(copySource, length, out page, out start, allocator);
